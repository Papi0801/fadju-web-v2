...
const MedecinProfilPage: React.FC = () => {
    ...
    <DashboardLayout>
      ...
      >
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold text-foreground">Mon Profil Médecin</h1>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-3 mt-3">
                  ...
                  <Badge variant="secondary">
                    ...
                    Médecin depuis {(user as any).date_creation && typeof (user as any).date_creation.toDate === 'function' 
                      ? (user as any).date_creation.toDate().toLocaleDateString('fr-FR', { year: 'numeric', month: 'long' })
                      : new Date((user as any).date_creation || Date.now()).toLocaleDateString('fr-FR', { year: 'numeric', month: 'long' })
                    }
                  </Badge>
                </div>
              </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold">Établissement de santé</h3>
                  <p className="text-sm text-muted-foreground mt-1">
                    Vous exercez dans un établissement de santé partenaire
                  </p>
                </div>
                <Button
                  variant="outline"
                  onClick={() => router.push('/medecin/etablissement')}
                >
                  Voir les détails
                </Button>
              </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmitProfile(onSubmitProfile)} className="space-y-6">
                ...
                <div>
                  ...
                  {errorsProfile.specialite && (
                    <p className="text-sm text-destructive mt-1">{errorsProfile.specialite.message}</p>
                  )}
                  {selectedSpecialite && (
                    <div className="mt-2">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-300 mt-1" style={theme === 'light' ? { color: 'white' } : {}}>
                        Assurez-vous d'utiliser un mot de passe fort d'au moins 8 caractères pour protéger votre compte professionnel
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Vous serez déconnecté de votre espace médecin
                </p>
              </div>
              <Button
                variant="outline"
